...
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/04_covariates/data/log/covariate_extraction-%j.out

#################
#   JOB INFO    #
#################

Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/04_covariates/script/covariate_extraction.R
