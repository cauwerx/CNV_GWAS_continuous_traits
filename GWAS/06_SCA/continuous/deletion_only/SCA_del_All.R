...
n <- nrow(as.data.frame(fread("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/final/All/significant_associations/00_significant_All_del.txt.gz", header = T, select = c(1:3, 8:9, 13:15))))
...
if (round == 1) {
		new_sig <- as.data.frame(fread("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/final/All/significant_associations/00_significant_All_del.txt.gz", header = T, select = c(1:3, 8:9, 13:15)))
	} else {
		new_sig <- as.data.frame(fread(paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/significant_associations/All/sig_assoc_del_SCA_round", round-1, ".txt.gz"), header = T, select = c(1:3, 8:9, 13:15)))}
...
if (round == 1) {
		...
		sum_file <- as.data.frame(fread(paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/summary/All/summary_del_SCA_round", round-1, ".txt"), header = T))
		sum_file <- rbind(sum_file, new_sig)}

print(paste0("Total number of independent signals after round ",round,": ", nrow(sum_file)))
fwrite(sum_file, paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/summary/All/summary_del_SCA_round", round, ".txt"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
...
for(i in 1:nrow(probes)) {
	...
	# Write file
	fwrite(data.frame(rs), paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/cnv_profiles/All/", rs), col.names = F, row.names = F, quote = F, sep = "\t")
	...
	output <- paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/cnv_profiles/All/", rs)
...
for (i in 2:ncol(pheno)) {
	...
	for (rs in rs_list$ID) {
		rs_profile <- as.data.frame(fread(paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/cnv_profiles/All/", rs, "_profile"), header = T))
...
fwrite(pheno_cor, paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/phenotypes/All/pheno_cor_round", round, ".txt"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
...
print("Strating GWAS")
system(paste0("mkdir /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/associations/All/round", round))
...
for(chr in chromosomes) {
	...
	pheno_file <- paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/phenotypes/All/pheno_cor_round", round, ".txt") # INT, covariate-corrected phenotype file generate above
	...
	output <- paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/associations/All/round", round,"/gwas_del_SCA_round", round,"_chr", chr)
...
list_gwas <- list.files(paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/associations/All/round", round), pattern = ".glm.linear", full.names = T, recursive = F)
...
fwrite(sig_gwas, paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/08_SCA/continuous/white_british/deletion_only/data/temp/significant_associations/All/sig_assoc_del_SCA_round", round, ".txt.gz"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
rm(f, df, temp_sig)
