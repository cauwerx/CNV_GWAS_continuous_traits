...
#SBATCH --array=1-24 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/data/log/01_gwas_PD_clumping_mirror-%A_%a.out
...
# Output
output_gwas_M=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/data/temp/M/associations/gwas_PD_mirror_M_chr${chr}")
output_gwas_F=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/data/temp/F/associations/gwas_PD_mirror_F_chr${chr}")
output_gwas_all=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/data/temp/All/associations/gwas_PD_mirror_All_chr${chr}")
