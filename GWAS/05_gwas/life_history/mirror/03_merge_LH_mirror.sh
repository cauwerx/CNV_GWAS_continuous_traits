...
#SBATCH --array=1-3 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/data/log/03_gwas_PD_merge_mirror-%A_%a.out
...
Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/mirror/script/03_merge_LH_mirror.R ${s}
