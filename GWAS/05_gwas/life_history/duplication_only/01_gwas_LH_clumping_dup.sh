...
#SBATCH --array=1-24 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/duplication_only/data/log/01_gwas_PD_clumping_dup-%A_%a.out
...
# Output
output_gwas_M=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/duplication_only/data/temp/M/associations/gwas_PD_dup_M_chr${chr}")
output_gwas_F=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/duplication_only/data/temp/F/associations/gwas_PD_dup_F_chr${chr}")
output_gwas_all=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/duplication_only/data/temp/All/associations/gwas_PD_dup_All_chr${chr}")
