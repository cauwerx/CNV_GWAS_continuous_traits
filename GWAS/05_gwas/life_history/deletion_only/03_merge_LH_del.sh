...
#SBATCH --array=1-3 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/deletion_only/data/log/03_gwas_PD_merge_del-%A_%a.out
...
Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/life_history/white_british/deletion_only/script/03_merge_LH_del.R ${s}
