...
#SBATCH --array=1-3 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/data/log/02_gwas_correct_dup-%A_%a.out
...
Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/script/02_correct_gwas_dup.R ${s}
