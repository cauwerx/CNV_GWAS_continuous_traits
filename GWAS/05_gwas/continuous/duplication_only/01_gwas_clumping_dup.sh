...
#SBATCH --job-name=gwas_dup         # Give your job a name to recognize it in queue overview
...
#SBATCH --array=1-24 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/data/log/01_gwas_clumping_dup-%A_%a.out
...
# Probes (from GWAS/02_probes/duplication_only/probe_pruning_dup.R; r^2 at 0.9999)
probes=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/02_probes/white_british/stringent/duplication_only/data/final/pruning/r_0.9999/probes_WB_All_prune_0.9999_dup_chr${chr}.prune.in")

# Output
output_gwas_M=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/data/temp/M/associations/gwas_dup_M_chr${chr}")
output_gwas_F=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/data/temp/F/associations/gwas_dup_F_chr${chr}")
output_gwas_all=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/duplication_only/data/temp/All/associations/gwas_dup_All_chr${chr}")
