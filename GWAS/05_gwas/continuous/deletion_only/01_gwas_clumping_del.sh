...
#SBATCH --array=1-24 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/log/01_gwas_clumping_del-%A_%a.out
...
# Output
output_gwas_M=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/temp/M/associations/gwas_del_M_chr${chr}")
output_gwas_F=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/temp/F/associations/gwas_del_F_chr${chr}")
output_gwas_all=$(echo "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/temp/All/associations/gwas_del_All_chr${chr}")
