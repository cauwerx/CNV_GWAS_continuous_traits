...
#SBATCH --array=1-3 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/data/log/03_gwas_merge_del-%A_%a.out
...
Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/06_gwas/continuous/white_british/deletion_only/script/03_merge_del.R ${s}
