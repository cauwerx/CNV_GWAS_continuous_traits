...
# Parallelize
#SBATCH --array=1-24 
#SBATCH --output=/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/02_probes/white_british/stringent/deletion_only/data/log/probe_pruning_del-%A_%a.out
...
Rscript /home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/02_probes/white_british/stringent/deletion_only/script/probe_pruning_del.R ${chr}
