# Locus zoom between the 17q12 locus and associated traits
...
fwrite(data.frame(hm$SNP), "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17q12_RCAD/data/temp/locus_zoom/high_missingness.txt", col.names = F, row.names = F, quote = F, sep = "\t")
...
HM_file <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17q12_RCAD/data/temp/locus_zoom/high_missingness.txt"

# Output file
output_file <- paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17q12_RCAD/data/temp/locus_zoom/dup_All_chr", chr, ":", start, ":", end)
...
for(p in unlist(strsplit(pheno, " "))) {
	...
	fwrite(df, paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17q12_RCAD/data/final/locus_zoom/dup_All_chr", chr, ":", start, "-", end, ".", p, ".glm.linear"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
