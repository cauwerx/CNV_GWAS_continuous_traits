# Locus zoom between the 17p12 locus and associated traits
...
fwrite(data.frame(hm$SNP), "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17p12_CMT1A/data/temp/locus_zoom/high_missingness.txt", col.names = F, row.names = F, quote = F, sep = "\t")
...
plink_file <- paste0("/data/FAC/FBM/DBC/zkutalik/default_sensitive/cauwerx/CNV_GWA/duplication_only/ukb_cnv_bed/ukb_cnv_chr", chr)
...
HM_file <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17p12_CMT1A/data/temp/locus_zoom/high_missingness.txt"

# Output file
output_file <- paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17p12_CMT1A/data/temp/locus_zoom/dup_All_chr", chr, ":", start, ":", end)
...
for(p in unlist(strsplit(pheno, " "))) {
	...
	fwrite(df, paste0("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/99_candidates/17p12_CMT1A/data/final/locus_zoom/dup_All_chr", chr, ":", start, "-", end, ".", p, ".glm.linear"), col.names = T, row.names = F, quote = F, sep = "\t", na = NA)
