...
# Load duplicattion burden; from Burden_analysis/CNV_burden/03_DEL_burden_calculation.R 
cnv_burden <- as.data.frame(fread("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/05_phenotypes/CNV_burden/white_british/data/final/DUP_burden.txt.gz", header = T)) 
...
# Save
fwrite(results, "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/final/meta_analysis/association_original_scale/summary_stat_DUP_burden_parental_lifespan_original_scale.txt", col.names = T, row.names = F, quote = F, sep = "\t")
...
gwama_mother_file <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/temp/GWAMA_input/mother_lifespan_GWAMA_input.txt"
...
gwama_father_file <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/temp/GWAMA_input/father_lifespan_GWAMA_input.txt"
fwrite(gwama_father_input, gwama_father_file, col.names = T, row.names = F, quote = F, sep = "\t") 
 
# Create a GWAMA file list
gwama_file_list <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/temp/GWAMA_input/GWAMA_input_file_list.txt" 
fwrite(data.frame(FILE = c(gwama_mother_file, gwama_father_file)), gwama_file_list, col.names = F, row.names = F, quote = F, sep = "\t")

# Determine the output path
gwama_output  <- "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/final/meta_analysis/GWAMA/DUP_burden_parental_lifespan_original_meta"
