# Life history traits association with duplication burden
...
# Load duplication burden; from Burden_analysis/CNV_burden/03_DEL_burden_calculation.R 
...
fwrite(results, "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/duplication_only/data/final/summary_stat_DUP_burden_LH.txt", col.names = T, row.names = F, quote = F, sep = "\t")
