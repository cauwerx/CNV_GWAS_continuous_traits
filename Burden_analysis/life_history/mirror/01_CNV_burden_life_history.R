# Life history traits association with CNV burden
...
fwrite(results, "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/life_history/white_british/mirror/data/final/summary_stat_CNV_burden_LH.txt", col.names = T, row.names = F, quote = F, sep = "\t")
