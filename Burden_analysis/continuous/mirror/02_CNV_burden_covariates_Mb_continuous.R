...
cnv_burden <- as.data.frame(fread("/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/05_phenotypes/CNV_burden/white_british/data/final/CNV_burden.txt.gz", header = T, select = c(1,2,4))) 
...
fwrite(results, "/home/cauwerx/scratch/cauwerx/projects/cnv_gwas/gwas/12_burden_analysis/continuous/white_british/mirror/data/final/SumStat_CNVR_Mb/SumStat_CNV_burden_CNVR_Mb_continuous_All.txt", col.names = T, row.names = F, quote = F, sep = "\t")
